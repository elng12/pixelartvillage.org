...
async function prerender() {
  ...
  const BLOG_POST_META = {
    ...
    'how-many-pixels-do-you-need-for-a-4x6-photo-or-banner': {
      ...
      bestFor: 'Getting concrete pixel targets for 4x6 prints, web banners, and printed banners before export.',
      whyRead: 'This guide turns vague size questions into concrete pixel targets for both small photo prints and banner layouts.',
      nextStep: 'Read the 96 PPI guide next if you want to understand why density and pixel dimensions are not the same thing.',
    },
    'what-does-96-pixels-per-inch-really-mean': {
      badge: '96 PPI',
      chipClass: 'border-lime-200 bg-lime-50 text-lime-800',
      sectionId: 'workflow-export',
      bestFor: 'Understanding why 96 PPI is only a density label before you export for screen or print.',
      whyRead: 'This guide explains the difference between density labels and real pixel dimensions in plain English, with clearer print-vs-web framing.',
      nextStep: 'Use it together with the 4x6 and banner size guide when you need practical export targets.',
    },
    'how-many-pixels-is-4k-and-8k': {
      badge: '4K & 8K',
      chipClass: 'border-violet-200 bg-violet-50 text-violet-800',
      sectionId: 'workflow-export',
      bestFor: 'Comparing 4K and 8K pixel dimensions before you resize, export, or choose a source image.',
      whyRead: 'This guide turns 4K and 8K numbers into plain-English answers you can actually use while editing images.',
      nextStep: 'Read the general resolution guide next if you want the bigger picture behind width, height, PPI, and print size.',
    },
    'what-is-resolution-in-pixels': {
      badge: 'Resolution',
      chipClass: 'border-teal-200 bg-teal-50 text-teal-800',
      sectionId: 'workflow-export',
      bestFor: 'Understanding pixel size before you resize, print, or convert an image.',
      whyRead: 'This guide explains the difference between pixel dimensions and print density in plain English.',
      nextStep: 'Use it before resizing or converting an image so you choose a cleaner starting size.',
    },
