...
const blogPostsBase = [
  {
    ...
    "title": {
      "fil": "Ang 10 Pinakamahusay Converter nga Pagkumparahan (2025) - Kumpletong Gabay",
      ...
      "no": "De 10 Beste Pixel-Art-Konverterne Sammenlignet (2025) - Komplett Guide",
    ...
    "date": "2025-11-01",
    "tags": {
      "fil": ["paghahambing", "mga kagamitan", "pixel art converter", "pinakamahusay kagamitan", "gabay"],
      ...
      "no": ["sammenligning", "verktøy", "pixel art converter", "beste verktøy", "guide"],
  ...
  },
  {
    ...
    "title": {
      "fil": "Kumpletong Gabay sa Pixel Art para sa mga Nagsisimula (2025) - Mula Wala Hangang Paglikha",
      ...
      "no": "Komplett Guide for Pixel Art for Nybegynnere (2025) - Fra Null til å Lage",
    ...
    "date": "2025-10-28",
    "tags": {
      "fil": ["gabay", "pagsasanay", "nagsisimula", "pag-aaral ng pixel", "pamamaraan", "teknika"],
      ...
      "no": ["guide", "opplæring", "nybegynnere", "pixel art lære", "teknikker"],
  ...
  },
  {
    ...
    "title": {
      "fil": "Tutorial sa Pag-aanimasyon ng Pixel Art - Bawat-bawat Frame para sa mga Nagsisimula",
      ...
      "no": "Pixel Art Animasjon Tutorial Frame for Frame for Nybegynnere",
    ...
    "date": "2025-10-25",
    "tags": {
      "fil": ["pag-aanimasyon", "tutorial", "bawat-bawat frame", "pixel art animation", "pamamaraan", "mga prinsipyo"],
      ...
      "no": ["animasjon", "opplæring", "frame for frame", "pixel art animasjon", "prinsipper"],
  ...
  },
  {
    ...
    "title": {
      "fil": "Kumpletong Gabay sa Teorya ng Kulay para sa Pixel Art - Pang-ulo sa mga Palette",
      ...
      "no": "Komplett Guide for Fargelære for Pixel Art - Mestre Paletter",
    ...
    "date": "2025-10-20",
    "tags": {
      "fil": ["teorya ng kulay", "mga palette", "pagharmoni ng kulay", "kulay pixel", "disenyo ng kulay"],
      ...
      "no": ["fargelære", "paletter", "fargeharmoni", "pixel farge", "fargedesign"],
  ...
  },
  {
    ...
    "title": {
      "fil": "Gabay sa Pang-ulo sa mga Tekniko sa Pixel Art - Mula Pagsisimula hanggang Eksperto",
      ...
      "no": "Guide til Mestring av Pixel Art Teknikker - Fra Nybegynner til Ekspert",
    ...
    "date": "2025-10-15",
    "tags": {
      "fil": ["mga pangagam na tekniko", "pang-ulo", "teknikong pixel art", "pagpapabuti", "kahusayan"],
      ...
      "no": ["avanserte teknikker", "mestring", "pixel art teknikker", "perfeksjonisme", "ferdigheter"],
...
// 创建语言特定的博客文件
const languages = [
  { code: 'fil', name: 'Filipino', articles: blogPostsBase },
  ...
  { code: 'no', name: 'Norsk', articles: blogPostsBase },
...
function getLocalizedExcerpt(slug, lang) {
  ...
  const excerpts = {
    'best-pixel-art-converters-compared-2025': {
      ...
      'fil': 'Ikumpara ang 10 pinakamahusay converter batay sa pagiging, mga tampok, kalidad, at kadalianan ng paggamit.',
      ...
      'no': 'Sammenlign de 10 beste pixel-art-konverterne basert på personvern, funksjoner, kvalitet og brukervennlighet.',
