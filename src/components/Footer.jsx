...
function Footer() {
  const gridStyle = {
    backgroundImage:
      'linear-gradient(to right, rgba(167,139,250,0.09) 1px, transparent 1px), linear-gradient(to bottom, rgba(59,130,246,0.09) 1px, transparent 1px)',
        ...
        <div className="container mx-auto px-4 py-12 relative">
          ...
          <div className="mt-10 pt-6 border-t border-gray-700/60 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-xs text-gray-400">
              ...
              <span aria-hidden>•</span>
              <a href="#how-it-works" className="hover:text-white">Accessibility</a>
            </div>
          </div>
        </div>
      </div>
